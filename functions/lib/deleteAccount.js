 ...
 */
async function deleteSubcollection(collectionPath, batchSize) {
 ...
 */
async function deleteDocumentsWhere(collectionName, field, value, batchSize) {
    const query = db
 ...
 */
async function redactAnalytics(uid) {
 ...
 */
async function logAccountDeletion(uid) {
    try {
