...
/// Production entrypoint for BrightSide
///
/// Run with: flutter run -t lib/main_prod.dart --dart-define=PROD=true
/// Build: flutter build ios -t lib/main_prod.dart --dart-define=PROD=true
///
/// Features:
...
void main() async {
  ...
  // Initialize Firebase (production - no emulators)
  await initFirebase();
