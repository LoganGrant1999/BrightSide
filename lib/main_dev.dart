...
/// Development entrypoint for BrightSide
///
/// Run with: flutter run -t lib/main_dev.dart
///
/// Features:
/// - Connects to Firebase emulators (localhost:8080, 9099, 5001, 9199)
/// - Debug menu visible in Settings
/// - Crashlytics test enabled
